...
@Singleton
class RetrieveChargeHistoryByTransactionIdValidatorFactory {

  def validator(nino: String, transactionId: String): Validator[RetrieveChargeHistoryByTransactionIdRequestData] =
    new Validator[RetrieveChargeHistoryByTransactionIdRequestData] {
