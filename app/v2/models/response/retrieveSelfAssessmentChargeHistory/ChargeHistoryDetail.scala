...
object ChargeHistoryDetail {
  ...
  implicit val reads: Reads[ChargeHistoryDetail] = ((JsPath \ "taxYear").readNullable[String] and
  ...
  implicit val writes: Writes[ChargeHistoryDetail] = Json.writes[ChargeHistoryDetail]
}
