...
object ListPaymentsAndAllocationDetailsService {
  val downstreamErrorMap: Map[String, MtdError] =
    Map(
      ...
      "INVALID_PAYMENT_LOT" -> InvalidPaymentLot,
      "INVALID_PAYMENT_LOT_ITEM" -> InvalidPaymentLotItem,
      "INVALID_CLEARING_DOC" -> InternalError,
      "INVALID_DATE_FROM" -> InvalidStartDateError,
      "INVALID_DATE_TO" -> InvalidEndDateError,
