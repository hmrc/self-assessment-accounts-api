...
object TaxCodeComponents {
  ...
  implicit val reads: Reads[TaxCodeComponents] = Json.reads[TaxCodeComponents]

  implicit val writes: Writes[TaxCodeComponents] = Json.writes[TaxCodeComponents]
}
