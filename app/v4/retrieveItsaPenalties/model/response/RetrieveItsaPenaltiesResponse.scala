...
import v4.retrieveItsaPenalties.def1.model.response.*
...
object RetrieveItsaPenaltiesResponse {
  ...
  private val path = JsPath \ "success" \ "penaltyData"

  implicit val reads: Reads[RetrieveItsaPenaltiesResponse] = (
    (path \ "totalisations").readNullable[Totalisations] and
      (path \ "lsp").readNullable[LateSubmissionPenalty] and
      (path \ "lpp").readNullable[LatePaymentPenalty]
