...
class MockRetrieveBalanceAndTransactionsValidator extends MockFactory {

  val mockValidator: RetrieveBalanceAndTransactionsValidator = mock[RetrieveBalanceAndTransactionsValidator]
