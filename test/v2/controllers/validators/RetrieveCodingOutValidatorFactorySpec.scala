...
class RetrieveCodingOutValidatorFactorySpec extends UnitSpec with MockAppConfig {
  ...
  private val validatorFactory = new RetrieveCodingOutValidatorFactory(mockAppConfig)
  ...
  "validator" should {
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(RetrieveCodingOutRequestData(parsedNino, parsedTaxYear, parsedSource))
      }
    }
