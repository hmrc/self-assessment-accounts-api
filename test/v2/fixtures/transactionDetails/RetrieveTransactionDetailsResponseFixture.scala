...
package v2.fixtures.transactionDetails

import play.api.libs.json.{JsValue, Json}
import v2.models.response.retrieveTransactionDetails.{RetrieveTransactionDetailsResponse, SubItem, TransactionItem}
...
trait RetrieveTransactionDetailsResponseFixture {
  ...
  val desJsonEmpty: JsValue = Json.parse(
    """
      |{
      |   "financialDetails": [
      |     {
