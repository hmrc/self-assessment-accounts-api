...
trait MockRetrieveCodingOutService extends TestSuite with MockFactory {

  val mockRetrieveCodingOutService: RetrieveCodingOutService = mock[RetrieveCodingOutService]
