...
trait MockRetrieveChargeHistoryByTransactionIdService extends TestSuite with MockFactory {

  val mockRetrieveChargeHistoryByTransactionIdService: RetrieveChargeHistoryByTransactionIdService = mock[RetrieveChargeHistoryByTransactionIdService]
