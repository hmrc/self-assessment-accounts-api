...
import v3.connectors.MockRetrieveChargeHistoryByChargeReferenceConnector
import v3.models.request.retrieveChargeHistory.RetrieveChargeHistoryByChargeReferenceRequestData
import v3.models.response.retrieveChargeHistory.{ChargeHistoryDetail, RetrieveChargeHistoryResponse}
...
class RetrieveChargeHistoryByChargeReferenceServiceSpec extends ServiceSpec {
  ...
  private val requestData: RetrieveChargeHistoryByChargeReferenceRequestData =
    RetrieveChargeHistoryByChargeReferenceRequestData(
      nino = nino,
