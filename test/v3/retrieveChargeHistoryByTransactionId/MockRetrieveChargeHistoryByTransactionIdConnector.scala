...
trait MockRetrieveChargeHistoryByTransactionIdConnector extends TestSuite with MockFactory {

  val mockRetrieveChargeHistoryByTransactionIdConnector: RetrieveChargeHistoryByTransactionIdConnector =
    mock[RetrieveChargeHistoryByTransactionIdConnector]

  object MockRetrieveChargeHistoryByTransactionIdConnector {

    def retrieveChargeHistoryByTransactionId(
        requestData: RetrieveChargeHistoryByTransactionIdRequestData): CallHandler[Future[DownstreamOutcome[RetrieveChargeHistoryResponse]]] = {
      (
