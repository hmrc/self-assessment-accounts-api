...
trait MockRetrieveAllocationsService extends MockFactory {

  val mockRetrieveAllocationsService: RetrieveAllocationsService = mock[RetrieveAllocationsService]
    ...
    def retrieveAllocations(request: RetrieveAllocationsParsedRequest)
      ...
      (
        mockRetrieveAllocationsService
          .retrieveAllocations(_: RetrieveAllocationsParsedRequest)(
            _: RequestContext,
            _: ExecutionContext
          )
        )
