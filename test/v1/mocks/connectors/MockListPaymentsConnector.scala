...
import v1.connectors.{DownstreamOutcome, ListPaymentsConnector}
...
trait MockListPaymentsConnector extends MockFactory {

  val mockListPaymentsConnector: ListPaymentsConnector = mock[ListPaymentsConnector]
