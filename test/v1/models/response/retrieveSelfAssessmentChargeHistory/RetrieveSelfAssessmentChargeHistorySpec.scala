...
class RetrieveSelfAssessmentChargeHistorySpec extends UnitSpec {
  ...
  val chargeHistoryDetail: ChargeHistoryDetail =
    ChargeHistoryDetail(
      Some("2018-19"),
      Some("123456789"),
      Some("2020-01-29"),
      Some("Balancing Charge"),
      Some(12345678912.12),
      Some("2020-02-24"),
      Some("amended return")
    )

  val validObjectSingle: RetrieveSelfAssessmentChargeHistoryResponse = RetrieveSelfAssessmentChargeHistoryResponse(Seq(chargeHistoryDetail))

  val validObjectMultiple: RetrieveSelfAssessmentChargeHistoryResponse =
    RetrieveSelfAssessmentChargeHistoryResponse(chargeHistoryDetails = Seq(chargeHistoryDetail, chargeHistoryDetail))
