...
class OptInToCodingOutControllerISpec extends IntegrationBaseSpec {

  "Calling the 'opt in to coding out' endpoint" when {
  ...
  private trait Test {
    ...
    def request: WSRequest = {
      setupStubs()
      buildRequest(s"/$nino/$taxYear/collection/tax-code/coding-out/opt-in")
        .withHttpHeaders(
